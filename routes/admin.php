...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web',  'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'students'], function () {
            ...
            Route::get('/onlyRegistered', 'UserController@onlyRegisteredUsers');
            Route::get('/registered', 'UserController@RegisteredUsers');
        ...
        Route::group(['prefix' => 'categories'], function () {
            ...
            Route::get('/{id}/requirements/{reqId}/delete', 'CategoryController@deleteRequirement');
        ...
        Route::group(['prefix' => 'codes'], function () {
            ...
            //////////////////////////////////////////////
            Route::get('/instructor', 'CodeController@index_instructor')->name('instructor_codes');
            Route::get('/instructor_create', 'CodeController@create_instructor');
            Route::post('/instructor_store', 'CodeController@store_instructor');
        ...
        Route::group(['prefix' => 'certificates'], function () {
            ...
            Route::get('/purchase', 'CertificateController@purchase');
