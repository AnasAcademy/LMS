...
(function ($) {
  ...
  $('body').on('click', '#newExperienceSwlModal #saveExperience', function (e) {
    ...
    var $input2 = $('#newExperienceSwlModal #new_experience_val2');
  ...
  $('body').on('click', '#editExperienceSwlModal #editExperience', function (e) {
    ...
    var $input2 = $('#editExperienceSwlModal #new_experience_val2');
    var user_id = $(this).attr('data-user-id');
...
let pattern = /title:\s*(.*?),\s*year:\s*(\d+)/;
...
if(matches){
    ...
    Swal.fire({
      ...
      onOpen: function onOpen() {
        ...
        editExperienceSwlModal.find('#new_experience_val2').val(val2);
