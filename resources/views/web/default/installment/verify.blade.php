...
</svg>                        <span class="font-14 text-gray ml-5">{{ handlePrice($installment->totalPayments($itemPrice)) }} {{ trans('financial.total_amount') }}</span> --}}
                    {{-- </div> --}}
...
<br>
             {{--   <div class="font-16 text-gray">{!! nl2br(getInstallmentsTermsSettings('terms_description')) !!}</div> --}}
                <div class="font-16 text-gray">
                    ...
                    <br>
1. خطة الدفع بالتقسيط: نقدم خطة الدفع بالتقسيط لبعض البرامج المحددة. باختيار خيار الدفع بالتقسيط، فإنك توافق على سداد رسوم البرنامج بالكامل على عدة أقساط. سيتم خصم كل قسط تلقائيًا من وسيلة الدفع التي قدمتها في التواريخ المحددة حتى يتم سداد المبلغ بالكامل.
<br>
2. رسوم خطة الدفع: قد تشمل خطة الدفع بالتقسيط رسوم معالجة بسيطة لكل دفعة. ستتم إظهار إجمالي رسوم المعالجة قبل اختيار خيار الدفع بالتقسيط.
                    <br>
3. الدفع المتأخر: في حالة عدم استلام الدفعة في التاريخ المحدد، قد يتم فرض رسوم على الدفعة المقررة في التاريخ التالي. <br>
4. عدم قابلية استرداد المبالغ: بمجرد سداد القسط ، لا يمكن استرداده  <br>
5. الافتراضي: في حالة عدم السداد أو عدم اكتمال خطة الدفع، سيتم إلغاء وصولك إلى البرنامج وغلق حسابكم لدى الأكاديمية <br>

6. الخصوصية: سيتم الحفاظ على سرية معلوماتك الشخصية ومعلومات الدفع. نحن نتبع إجراءات أمنية صارمة لحماية بياناتك وفقًا لمعايير الصناعة. <br>
7. تغييرات في الشروط والقواعد: نحتفظ بالحق في تعديل الشروط والقواعد في أي وقت. سيتم الإعلان عن أي تغييرات على موقعنا الإلكتروني وتصبح سارية فورًا. <br>
باستخدام خطة الدفع بالتقسيط الخاصة بنا، فإنك توافق على هذه الشروط والقواعد. للمزيد من الاستفسارات، يرجى التواصل مع فريق الدعم لدينا. <br>
