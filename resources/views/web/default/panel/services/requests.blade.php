                                    ...
                                    @foreach ($services as $service)
                                        <tr @if ($service->status == 'canceled') class="bg-light" style="opacity: 0.5" @endif>
                                            ...
                                            <td >
                                                ...
                                                <a class="text-primary" href="/panel/bundletransform/{{ $service->pivot->bundleTransform->id}}/pay">دفع الفرق و إتمام التحويل</a>
                                                ...
                                                <a class="text-primary" href="/panel/bundletransform/{{ $service->pivot->bundleTransform->id}}/refund">استيرداد الفرق و إتمام التحويل</a>
                                                @elseif (!empty($service->pivot->BridgingRequest && $service->pivot->BridgingRequest->bridging_id) && $service->pivot->status=="approved")
                                                <a class="text-primary" href="/panel/bundleBridging/{{ $service->pivot->BridgingRequest->bridging_id}}/pay">دفع ثمن البرنامج</a>
