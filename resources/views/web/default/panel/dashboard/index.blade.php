...
@section('content')
    <section class="dashboard">
        ...
        <div class="row p-20">
            <div class="col-12  mt-35 @if ($authUser->isUser())
                 col-lg-5
            @endif">
            ...
            @if ($authUser->isUser())
                <div class="col-12 col-lg-7 row">
                    ...
                    <div class="col-12 col-lg-6 mt-35 ">
                        <div
                            class="module-box dashboard-stats rounded-sm panel-shadow py-30 d-flex align-items-center mt-0">
                            ...
                            <div class="d-flex flex-column" style="align-items: center;">
                                ...
                                <span class="font-16 text-gray font-weight-500 text-center pb-10">فريق الدعم والتواصل
                                </span>
                    ...
                    <div class="col-12 col-lg-6 mt-35 ">
                        <div
                            class="module-box dashboard-stats rounded-sm panel-shadow p-10 p-md-15 d-flex align-items-center mt-0">
                            ...
                            <div class="d-flex flex-column pt-35 pb-50" style="align-items: center;">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
                                    ...
                                    <path
                                        ...
                                        opacity=".09" />
                                    <linearGradient id="DqqEodsTc8fO7iIkpib~Na" x1="4.648" x2="23.403" y1="14.648"
                                        y2="33.403" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#5961c3" />
                                        <stop offset="1" stop-color="#3a41ac" />
                                    </linearGradient>
                                    <path fill="url(#DqqEodsTc8fO7iIkpib~Na)"
                                ...
                                <span class="font-16 text-gray font-weight-500 text-center pb-10">برنامج ميكروسوفت
                                    تيمز</span>
    ...
    <section class="dashboard">
        <div class="row p-20">
            @if ($authUser->isUser())
                {{-- Calender --}}
                <div class="col-12 col-lg-6 mt-5 rounded-sm">
                            ...
                            <div class="card m-b-30">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h5 class="card-title mb-0">جدول المحاضرات</h5>
                                        </div>
                                        <div class="col-4">
                                                    ...
                                                    <li class="media mb-3">
                                                        ...
                                                        <div class="media-body">
                                                            <a href="{{ $bundleSale->bundle->content_table }}"
                                                                target="_blank">
                                                                <h5 class="font-16 mb-1"> {{ $bundleSale->bundle->title }}
