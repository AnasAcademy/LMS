                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped text-center font-14">
                                            ...
                                            @foreach ($item->bundleWebinars->sortBy(function ($bundleWebinar) {
                                                return optional($bundleWebinar->webinar)->start_date ?? PHP_INT_MAX; }) as $bundleWebinar)
                                                @php
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong
                            class="font-30 text-dark-blue font-weight-bold mt-5">{{ convertMinutesToHourAndMinute($hours) }}</strong>
