                                    ...
                                    @if ($webinar->isOwner($authUser->id) or $webinar->isPartnerTeacher($authUser->id))
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                {{-- <a href="/panel/webinars/ $webinar->id /edit" class="webinar-actions d-block mt-10">
                                                    trans('public.edit') </a> }}/edit" class="webinar-actions d-block mt-10">{{ trans('public.edit') }}
                                                    </a> --}}

                                                @if ($webinar->isWebinar())
                                                    <a href="/panel/webinars/{{ $webinar->id }}/step/4"
                                                        class="webinar-actions d-block mt-10">{{ trans('public.content') }}</a>
                                                @endif

                                                {{--   <a href="/panel/webinars/{{ $webinar->id }}/step/4" class="webinar-actions d-block mt-10">
                                                {{trans('public.files') }}</a> --}}
                                                ...
                                                <a href="/panel/webinars/{{ $webinar->id }}/statistics"
                                                    class="webinar-actions d-block mt-10">{{ trans('update.statistics') }}</a>
                                ...
                                <div class="webinar-price-box mt-15">
                                    @if ($webinar->price > 0)
                                        @if ($webinar->bestTicket() < $webinar->price)
                                            ...
                                            <span
                                                class="off ml-10">{{ handlePrice($webinar->price, true, true, false, null, true) }}</span>
                                        @else
                                            <span
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    @if ($webinar->isProgressing() and !empty($nextSession))
                                        ...
                                        @if ($webinar->isWebinar())
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                <span
                                                    class="stat-title">{{ trans('webinars.next_session_start_date') }}:</span>
                                                <span
