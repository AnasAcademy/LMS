...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ !empty($category) ? trans('/admin/main.edit') : trans('admin/main.new') }}
                {{ trans('admin/main.category') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ !empty($category) ? trans('/admin/main.edit') : trans('admin/main.new') }}
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{ getAdminPanelUrl() }}/categories/{{ !empty($category) ? $category->id . '/update' : 'store' }}"
                                method="Post">
                                {{ csrf_field() }}
                                ...
                                @if (!empty(getGeneralSettings('content_translate')))
                                    <div class="form-group">
                                        ...
                                        <select name="locale"
                                            class="form-control {{ !empty($category) ? 'js-edit-content-locale' : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="icon" id="icon"
                                            value="{{ !empty($category) ? $category->icon : old('icon') }}"
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input id="hasSubCategory" type="checkbox" name="has_sub"
                                            ...
                                            {{ (!empty($subCategories) and !$subCategories->isEmpty()) ? 'checked' : '' }}>
                                ...
                                <div id="requirements"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <button type="button" class="btn btn-success add-requirement-btn"><i
                                                class="fa fa-plus"></i> Add requirement</button>
                                    </div>

                                    <ul class="requirement-lists list-group">

                                        @if (!empty($category->categoryRequirements) and !$category->categoryRequirements->isEmpty())
                                            @foreach ($category->categoryRequirements as $key => $requirement)
                                                <li class="form-group list-group">
                                                    ...
                                                    <div class="p-2 border rounded-sm">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                name="requirements[{{ $requirement->id }}][title]"
                                                            ...
                                                            <div class="input-group-append">
                                                                @include('admin.includes.delete_button', [
                                                                    'url' => getAdminPanelUrl(
                                                                        "/categories/{$category->id}/requirements/{$requirement->id}/delete"),
                                                                    'deleteConfirmMsg' => trans(
                                                                        'update.category_delete_confirm_msg'),
                                                        ...
                                                        <div class="input-group w-100 mt-1">
                                                            <input type="text"
                                                                name="requirements[{{ $requirement->id }}][description]"
                                                                class="form-control w-auto flex-grow-1"
                                ...
                                <div id="subCategories"
                                    class="ml-0 {{ (!empty($subCategories) and !$subCategories->isEmpty()) ? '' : ' d-none' }}">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                                ...
                                                <li class="form-group list-group">
                                                    ...
                                                    <div class="p-2 border rounded-sm">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                name="sub_categories[{{ $subCategory->id }}][title]"
                                                                class="form-control w-auto flex-grow-1"
                                                            ...
                                                            <div class="input-group-append">
                                                                @include('admin.includes.delete_button', [
                                                                    'url' => getAdminPanelUrl(
                                                                        "/categories/{$subCategory->id}/delete"),
                                                                    'deleteConfirmMsg' => trans(
                                                                        'update.category_delete_confirm_msg'),
                                                                    'btnClass' => 'btn btn-danger text-white',
                                                                    'noBtnTransparent' => true,
                                                        ...
                                                        <div class="input-group w-100 mt-1">
                                                            <input type="text"
                                                                name="sub_categories[{{ $subCategory->id }}][slug]"
                                                                class="form-control w-auto flex-grow-1"
                                                        ...
                                                        <div class="input-group mt-1">
                                                            <div class="input-group-prepend">
                                                                <button type="button"
                                                                    ...
                                                                    data-input="icon_{{ $subCategory->id }}"
                                                                    data-preview="holder">
                                                                    <i class="fa fa-upload"></i>
                                                                </button>
                                                            </div>
                                                            <input type="text"
                                                                name="sub_categories[{{ $subCategory->id }}][icon]"
                                                                id="icon_{{ $subCategory->id }}" class="form-control"
                                                                value="{{ $subCategory->icon }}"
                                                                placeholder="{{ trans('admin/main.icon') }}" />
                                                        </div>
                                                    </div>
                                                </li>
                                            @endforeach
                            ...
                            <li class="form-group main-row list-group d-none">
                                <div class="p-2 border rounded-sm">
                                    ...
                                    <div class="input-group mt-1">
                                        <div class="input-group-prepend">
                                            <button type="button" class="input-group-text admin-file-manager "
                                                data-input="icon_record" data-preview="holder">
                                                <i class="fa fa-upload"></i>
                                            </button>
                                        </div>
                                        <input type="text" name="sub_categories[record][icon]" id="icon_record"
                                            class="form-control" placeholder="{{ trans('admin/main.icon') }}" />
                                    </div>
                                </div>
                            </li>
                            {{-- requirement row --}}
                            <li class="form-group requirement-row list-group d-none">
                                <div class="p-2 border rounded-sm">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text cursor-pointer move-icon">
                                        ...
                                        <input type="text" name="requirements[record][title]"
                                            class="form-control w-auto flex-grow-1"
                                            placeholder="{{ trans('admin/main.choose_title') }}" />

                                        <div class="input-group-append">
                                            <button type="button" class="btn remove-requirement-btn btn-danger"><i
                                                    class="fa fa-times"></i></button>
                                        </div>
                                    </div>

                                    <div class="input-group mt-1">
                                        <input type="text" name="requirements[record][description]"
                                            class="form-control w-auto flex-grow-1"
                                            placeholder="{{ trans('admin/main.decription') }}" />
                                    </div>
