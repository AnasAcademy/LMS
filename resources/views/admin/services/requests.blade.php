                                    ...
                                    <table class="table table-striped font-14 ">
                                        ...
                                        @foreach ($service->users as $user)
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center d-flex flex-column align-items-center justify-content-around">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($user->pivot->status == 'rejected')
                                                        @include('admin.includes.message_button', [
                                                            'url' => '#',
                                                            'btnClass' => 'd-flex align-items-center justify-content-center mt-1 text-danger',
                                                            'btnText' =>
