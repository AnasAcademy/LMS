                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_bundles_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/edit?type={{ $bundle->type }}" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.edit') }}">
