<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_requirements')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/requirements*', false)) ? 'active' : '' }}">
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            ...
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'webinar') ? 'active' : '' }}">
                                <a class="nav-link @if (!empty($sidebarBeeps['webinars']) and $sidebarBeeps['webinars']) beep beep-sidebar @endif"
                                    href="{{ getAdminPanelUrl() }}/webinars?type=webinar">{{ trans('admin/main.live_classes') }}</a>
                            </li>

                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'text_lesson') ? 'active' : '' }}">
                                <a class="nav-link @if (!empty($sidebarBeeps['textLessons']) and $sidebarBeeps['textLessons']) beep beep-sidebar @endif"
                                    href="{{ getAdminPanelUrl() }}/webinars?type=text_lesson">{{ trans('admin/main.text_courses') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_webinars_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/webinars/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/webinars/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_agora_history_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/agora_history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/agora_history">{{ trans('update.agora_history') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_upcoming_courses')
                <li
                    class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/upcoming_courses*', false)) and !request()->is(getAdminPanelUrl('/upcoming_courses/comments*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_upcoming_courses_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/upcoming_courses', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/upcoming_courses') }}">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()

                        @can('admin_upcoming_courses_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/upcoming_courses/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/upcoming_courses/new') }}">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_codes')
                <li class="{{ request()->is(getAdminPanelUrl('/codes*', false)) ? 'active' : '' }}">
                    <a class="nav-link " href="{{ getAdminPanelUrl() }}/codes">
                        <i class="fas fa-file"></i>
            ...
            @can('instructor_codes')
                <li class="{{ request()->is(getAdminPanelUrl('/codes*', false)) ? 'active' : '' }}">
                    <a class="nav-link " href="{{ getAdminPanelUrl() }}/codes/instructor">
                        <i class="fas fa-file"></i>
                        <span>أكواد االمعلمين</span>
                    </a>
                </li>
            @endcan()
            ...
            @can('admin_certificate')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/certificates*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-certificate"></i>
                        <span>{{ trans('admin/main.certificates') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        @can('admin__purchased_certificate_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/certificates', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/purchase">الشهادات المعتمدة</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_certificate_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/certificates', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/certificates">{{ trans('update.quizzes_related') }}</a>
                            </li>
                        @endcan

                        @can('admin_course_certificate_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/certificates/course-competition', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/certificates/course-competition">{{ trans('update.course_certificates') }}</a>
                            </li>
                        @endcan

                        @can('admin_certificate_template_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/certificates/templates', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_certificate_template_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/certificates/templates/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
            ...
            @can('admin_course_noticeboards_list')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/course-noticeboards*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_course_noticeboards_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/course-noticeboards', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/course-noticeboards">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan

                        @can('admin_course_noticeboards_send')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/course-noticeboards/send', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/course-noticeboards/send">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_enrollment')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/enrollments*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_enrollment_history')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/enrollments/history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/enrollments/history">{{ trans('public.history') }}</a>
                            </li>
                        @endcan

                        @can('admin_enrollment_add_student_to_items')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/enrollments/add-student-to-class', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/enrollments/add-student-to-class">{{ trans('update.add_student_to_a_class') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_categories')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/categories*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-th"></i>
            ...
            @can('admin_filters')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/filters*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_filters_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/filters', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/filters">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_filters_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/filters/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/filters/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_reviews_lists')
                <li class="{{ request()->is(getAdminPanelUrl('/reviews', false)) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/reviews"
                        class="nav-link @if (!empty($sidebarBeeps['reviews']) and $sidebarBeeps['reviews']) beep beep-sidebar @endif">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_staffs_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/staffs', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/staffs">{{ trans('admin/main.staff') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_instructors_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/instructors', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/instructors">{{ trans('home.instructors') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_organizations_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/organizations', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/organizations">{{ trans('admin/main.organizations') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_users_not_access_content_lists')
                <li
                    class="{{ request()->is(getAdminPanelUrl('/users/not-access-to-content', false)) ? 'active' : '' }}">
            ...
            @can('admin_delete_account_requests')
                <li
                    class="nav-item {{ request()->is(getAdminPanelUrl('/users/delete-account-requests*', false)) ? 'active' : '' }}">
                        ...
                        @can('admin_roles_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/roles', false)) ? 'active' : '' }}">
                                <a class="nav-link active"
                                    href="{{ getAdminPanelUrl() }}/roles">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_roles_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/roles/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/roles/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_group')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/users/groups*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_group_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/users/groups', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/users/groups">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan
                        @can('admin_group_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/users/groups/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/users/groups/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_become_instructors_list')
                <li
                    ...
                    <ul class="dropdown-menu">
                        <li
                            class="{{ request()->is(getAdminPanelUrl('/users/become-instructors/instructors', false)) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ request()->is(getAdminPanelUrl('/users/become-instructors/organizations', false)) ? 'active' : '' }}">
            ...
            @if ($authUser->can('admin_forum') or $authUser->can('admin_featured_topics'))
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_forum_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/forums', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/forums">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_forum_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/forums/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/forums/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_featured_topics')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/featured-topics*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_featured_topics_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/featured-topics', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/featured-topics">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_featured_topics_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/featured-topics/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/featured-topics/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_recommended_topics')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/recommended-topics*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_recommended_topics_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/recommended-topics', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/recommended-topics">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_recommended_topics_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/recommended-topics/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/recommended-topics/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_support_departments')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/supports/departments', false)) ? 'active' : '' }}">
                                <a class="nav-link"
            ...
            @can('admin_comments')
                <li
                    class="nav-item dropdown {{ (!request()->is(getAdminPanelUrl('admin/comments/products, false')) and (request()->is(getAdminPanelUrl('/comments*', false)) and !request()->is(getAdminPanelUrl('/comments/webinars/reports', false)))) ? 'active' : '' }}">
                        ...
                        @can('admin_webinar_comments')
                            <li class="{{ request()->is(getAdminPanelUrl('/comments/webinars', false)) ? 'active' : '' }}">
                                <a class="nav-link @if (!empty($sidebarBeeps['classesComments']) and $sidebarBeeps['classesComments']) beep beep-sidebar @endif"
                                    href="{{ getAdminPanelUrl() }}/comments/webinars">{{ trans('admin/main.classes_comments') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_reports')
                <li
                    class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/reports*', false)) or request()->is(getAdminPanelUrl('/comments/webinars/reports', false)) or request()->is(getAdminPanelUrl('/comments/blog/reports', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinar_reports')
                            <li class="{{ request()->is(getAdminPanelUrl('/reports/webinars', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/reports/webinars">{{ trans('panel.classes') }}</a>
                            </li>
                        @endcan

                        @can('admin_webinar_comments_reports')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/comments/webinars/reports', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/comments/webinars/reports">{{ trans('admin/main.classes_comments_reports') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_report_reasons')
                            <li class="{{ request()->is(getAdminPanelUrl('/reports/reasons', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/reports/reasons">{{ trans('admin/main.report_reasons') }}</a>
                            </li>
                        @endcan()

                        @can('admin_forum_topic_post_reports')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/reports/forum-topics', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/reports/forum-topics">{{ trans('update.forum_topics') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_noticeboards')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/noticeboards*', false)) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_noticeboards_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/noticeboards', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/noticeboards">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_noticeboards_send')
                            <li class="{{ request()->is(getAdminPanelUrl('/noticeboards/send', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/noticeboards/send">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_notifications')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/notifications*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_notifications_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/notifications', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/notifications">{{ trans('public.history') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_notifications_send')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/notifications/send', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/notifications/send">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan

                        @can('admin_notifications_templates')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/notifications/templates', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/notifications/templates">{{ trans('admin/main.templates') }}</a>
                            </li>
                        @endcan

                        @can('admin_notifications_template_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/notifications/templates/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/notifications/templates/create">{{ trans('admin/main.new_template') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_store_new_product')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/store/products/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_store_products')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/products', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/products">{{ trans('update.products') }}</a>
                            </li>
                        @endcan()

                        @can('admin_store_in_house_products')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/store/in-house-products', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_store_products_orders')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/orders', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/orders">{{ trans('update.orders') }}</a>
                            </li>
                        @endcan()

                        @can('admin_store_in_house_orders')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/store/in-house-orders', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_store_products_sellers')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/sellers', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/sellers">{{ trans('update.sellers') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_store_filters_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/filters', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/filters">{{ trans('update.filters') }}</a>
                            </li>
                        @endcan()

                        @can('admin_store_specifications')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/store/specifications', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_store_discounts')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/discounts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/discounts">{{ trans('admin/main.discounts') }}</a>
                            </li>
                        @endcan()

                        @can('admin_store_products_comments')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/comments/products*', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/comments/products">{{ trans('admin/main.comments') }}</a>
                            </li>
                        @endcan()

                        @can('admin_products_comments_reports')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/comments/products/reports', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_store_products_reviews')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/reviews', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/reviews">{{ trans('admin/main.reviews') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_store_settings')
                            <li class="{{ request()->is(getAdminPanelUrl('/store/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/store/settings">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_blog_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/blog/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/blog/create">{{ trans('admin/main.new_post') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_blog_categories')
                            <li class="{{ request()->is(getAdminPanelUrl('/blog/categories', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/blog/categories">{{ trans('admin/main.categories') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_pages_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/pages', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/pages">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_pages_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/pages/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/pages/create">{{ trans('admin/main.new_page') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_additional_pages')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/additional_page*', false)) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_additional_pages_404')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/additional_page/404', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/additional_page/404">{{ trans('admin/main.error_404') }}</a>
                            </li>
                        @endcan()

                        @can('admin_additional_pages_contact_us')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/additional_page/contact_us', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_additional_pages_footer')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/additional_page/footer', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/additional_page/footer">{{ trans('admin/main.footer') }}</a>
                            </li>
                        @endcan()

                        @can('admin_additional_pages_navbar_links')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/additional_page/navbar_links', false)) ? 'active' : '' }}">
                                <a class="nav-link"
            ...
            @can('admin_testimonials')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/testimonials*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_testimonials_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/testimonials', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/testimonials">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()

                        @can('admin_testimonials_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/testimonials/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/testimonials/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_regions')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/regions*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_regions_countries')
                            <li class="{{ request()->is(getAdminPanelUrl('/regions/countries', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/regions/countries">{{ trans('update.countries') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_regions_provinces')
                            <li class="{{ request()->is(getAdminPanelUrl('/regions/provinces', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/regions/provinces">{{ trans('update.provinces') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_regions_cities')
                            <li class="{{ request()->is(getAdminPanelUrl('/regions/cities', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/regions/cities">{{ trans('update.cities') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_regions_districts')
                            <li class="{{ request()->is(getAdminPanelUrl('/regions/districts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/regions/districts">{{ trans('update.districts') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
            ...
            @can('admin_documents')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/documents*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_documents_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/documents', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/documents">{{ trans('admin/main.list') }}</a>
                            </li>
                        @endcan

                        @can('admin_documents_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/documents/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/documents/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_payouts')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/payouts*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown"><i class="fas fa-credit-card"></i>
                        <span>{{ trans('admin/main.payout') }}</span></a>
                    <ul class="dropdown-menu">
                        @can('admin_payouts_list')
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/financial/payouts', false)) and request()->get('payout') == 'requests') ? 'active' : '' }}">
                                <a href="{{ getAdminPanelUrl() }}/financial/payouts?payout=requests"
                        ...
                        @can('admin_payouts_list')
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/financial/payouts', false)) and request()->get('payout') == 'history') ? 'active' : '' }}">
            ...
            @can('admin_offline_payments_list')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/offline_payments*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown"><i class="fas fa-university"></i>
                        <span>{{ trans('admin/main.offline_payments') }}</span></a>
                    <ul class="dropdown-menu">
                        <li
                            class="{{ (request()->is(getAdminPanelUrl('/financial/offline_payments', false)) and request()->get('page_type') == 'requests') ? 'active' : '' }}">
                            <a href="{{ getAdminPanelUrl() }}/financial/offline_payments?page_type=requests"
            ...
            @can('admin_subscribe')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/subscribes*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_subscribe_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/subscribes', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/subscribes">{{ trans('admin/main.packages') }}</a>
                            </li>
                        @endcan

                        @can('admin_subscribe_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/subscribes/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/subscribes/new">{{ trans('admin/main.new_package') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_rewards')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/rewards*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_rewards_history')
                            <li class="{{ request()->is(getAdminPanelUrl('/rewards', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/rewards">{{ trans('public.history') }}</a>
                            </li>
                        @endcan
                        @can('admin_rewards_items')
                            <li class="{{ request()->is(getAdminPanelUrl('/rewards/items', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/rewards/items">{{ trans('update.conditions') }}</a>
                            </li>
                        @endcan
                        @can('admin_rewards_settings')
                            <li class="{{ request()->is(getAdminPanelUrl('/rewards/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/rewards/settings">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_registration_packages')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/registration-packages*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-gem"></i>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_registration_packages_lists')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/registration-packages', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/registration-packages">{{ trans('admin/main.packages') }}</a>
                            </li>
                        @endcan

                        @can('admin_registration_packages_new')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/registration-packages/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/registration-packages/new">{{ trans('admin/main.new_package') }}</a>
                            </li>
                        @endcan

                        @can('admin_registration_packages_reports')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/registration-packages/reports', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/registration-packages/reports">{{ trans('admin/main.reports') }}</a>
                            </li>
                        @endcan

                        @can('admin_registration_packages_settings')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/registration-packages/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/registration-packages/settings">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_discount_codes')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/discounts*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_discount_codes_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/discounts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/discounts">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan

                        @can('admin_discount_codes_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/discounts/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/discounts/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_product_discount')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/special_offers*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_product_discount_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/special_offers', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/special_offers">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan

                        @can('admin_product_discount_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/special_offers/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/special_offers/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_feature_webinars')
                            <li class="{{ request()->is(getAdminPanelUrl('/webinars/features', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/webinars/features">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()

                        @can('admin_feature_webinars_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/webinars/features/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/webinars/features/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_cashback')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/cashback*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_cashback_rules')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/cashback/rules/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/cashback/rules/new') }}">{{ trans('update.new_rule') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_cashback_rules')
                            <li class="{{ request()->is(getAdminPanelUrl('/cashback/rules', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/cashback/rules') }}">{{ trans('update.rules') }}</a>
                            </li>
                        @endcan

                        @can('admin_cashback_transactions')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/cashback/transactions', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/cashback/transactions') }}">{{ trans('update.transactions') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_cashback_history')
                            <li class="{{ request()->is(getAdminPanelUrl('/cashback/history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/cashback/history') }}">{{ trans('update.history') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_gift_history')
                            <li class="{{ request()->is(getAdminPanelUrl('/gifts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/gifts') }}">{{ trans('public.history') }}</a>
                            </li>
                        @endcan
                        @can('admin_gift_settings')
                            <li class="{{ request()->is(getAdminPanelUrl('/gifts/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/gifts/settings') }}">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_promotion')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/promotions*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_promotion_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/promotions', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/promotions">{{ trans('admin/main.plans') }}</a>
                            </li>
                        @endcan
                        @can('admin_promotion_list')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/promotions/sales', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/promotions/sales">{{ trans('admin/main.promotion_sales') }}</a>
                            </li>
                        @endcan

                        @can('admin_promotion_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/financial/promotions/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/promotions/new">{{ trans('admin/main.new_plan') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_advertising')
                <li
                    class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/advertising*', false)) and !request()->is(getAdminPanelUrl('/advertising_modal*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_advertising_banners')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/advertising/banners', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/advertising/banners">{{ trans('admin/main.list') }}</a>
                            </li>
                        @endcan

                        @can('admin_advertising_banners_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/advertising/banners/new', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/advertising/banners/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_newsletters_lists')
                            <li class="{{ request()->is(getAdminPanelUrl('/newsletters', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/newsletters">{{ trans('admin/main.list') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_newsletters_send')
                            <li class="{{ request()->is(getAdminPanelUrl('/newsletters/send', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/newsletters/send">{{ trans('admin/main.send') }}</a>
                            </li>
                        @endcan

                        @can('admin_newsletters_history')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/newsletters/history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/newsletters/history">{{ trans('public.history') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_referrals')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/referrals*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_referrals_history')
                            <li class="{{ request()->is(getAdminPanelUrl('/referrals/history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/referrals/history">{{ trans('public.history') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_referrals_users')
                            <li class="{{ request()->is(getAdminPanelUrl('/referrals/users', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/referrals/users">{{ trans('admin/main.affiliate_users') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_registration_bonus')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/registration_bonus*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-gem"></i>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_registration_bonus_history')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/registration_bonus/history', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/registration_bonus/history') }}">{{ trans('update.bonus_history') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_registration_bonus_settings')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/registration_bonus/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/registration_bonus/settings') }}">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_advertising_modal_config')
                <li
                    class="nav-item {{ request()->is(getAdminPanelUrl('/advertising_modal*', false)) ? 'active' : '' }}">
