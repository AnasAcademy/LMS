                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                ...
                                                <select name="type"
                                                    ...
                                                    <option value="graduation_project"
                                                        @if (!empty($webinar) and $webinar->isGraduationProject() or old('type') == \App\Models\Webinar::$graduationProject) selected @endif>مشروع تخرج
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <select name="unattached"
                                                    ...
                                                    <option value="1"
                                                        @if (old('unattached', $webinar->unattached ?? null) == '1') selected @endif>
                                                ...
                                                <select name="teacher_id" data-search-option="except_user"
                                                    ...
                                                    @if (!empty($webinar))
                                                        <option value="{{ $webinar->teacher->id }}" selected>
                                                            {{ $webinar->teacher->full_name }}</option>
                                                    @else
                                            ...
                                            <div id="partnerInstructorInput"
                                                ...
                                                <select name="partners[]" multiple data-search-option="just_teacher_role"
                                                    ...
                                                    @if (!empty($webinarPartnerTeacher))
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <option selected disabled>{{ trans('public.search_instructor') }}
                                                        </option>
                                                    @endif
                                                </select>
                                ...
                                @if (!empty($webinar))
                                    ...
                                    @foreach (\App\Models\WebinarExtraDescription::$types as $webinarExtraDescriptionType)
                                        <section class="mt-30">
                                            ...
                                            @php
                                                $webinarExtraDescriptionValues = $webinar->webinarExtraDescription->where(
                                                    'type',
                                                    $webinarExtraDescriptionType,
                                                );
                                            @endphp
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    @else
                                                        @include('admin.includes.no-result', [
                                                            'file_name' => 'faq.png',
                                                            'title' => trans(
                                                                "update.{$webinarExtraDescriptionType}_no_result"),
                                                            'hint' => trans(
                                                                "update.{$webinarExtraDescriptionType}_no_result_hint"),
                                                        ])
                                                    @endif
                                                </div>
                                            </div>
